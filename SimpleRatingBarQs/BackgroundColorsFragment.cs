...
{
    public class BackgroundColorsFragment : Android.Support.V4.App.Fragment
    {
        ...
        {
            View view = inflater.Inflate(Resource.Layout.fragment_background_colors, container, false);
            bindViews(view);
